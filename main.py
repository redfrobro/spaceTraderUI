...
# test_agent.contracts.contracts[0].accept(settings.settings['AGENT_TOKEN'])
print(test_agent.contracts.contracts[0])
print(test_agent.contracts.contracts[0].faction_symbol)
print(test_agent.contracts.contracts[0].cargo_to_deliver)
